...
import { Database, List, CheckCircle, Link2, FileText, Settings, User, LogOut, Users, ChevronLeft, ChevronRight, Key, Code, Globe } from "lucide-react";
...
const navigation = [
  ...
  { name: "Public Blacklist", href: "/public/blacklist", icon: Globe, roles: ["admin", "user", "reporter"] },
